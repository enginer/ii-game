...
public class ValueObjectUtils {
    ...
    public static <E> Collection<ModelMap> convertToPlainObjects(Collection<E> list, Modifier<E> modifier) throws Exception {
        return convertToPlainObjects(list, true, modifier);
    }
    public static <E> Collection<ModelMap> convertToPlainObjects(Collection<E> list, Boolean avoidTableAdmin, Modifier<E> modifier) throws Exception {
...
//                }
    ...
    public static interface Modifier<E> {
        void modify(E entity, ModelMap map) throws Exception;
    }
